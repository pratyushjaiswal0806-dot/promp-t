export const platform = {
  ...
  capabilities: [
    { icon: "⌨", title: "Workbench Controls", body: "Model search, mode selector (lossless/balanced/aggressive/context_file), sample loader, file import, inspector panels, and export controls.", tryIt: 'curl -X POST /v1/compile -d \'{"input":"...","mode":"balanced"}\'' },
