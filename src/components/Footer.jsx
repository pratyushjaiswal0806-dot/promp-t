  ...
  return (
    <footer className="footer" style={{ padding: "2rem 1.5rem 1.25rem", textAlign: "left", maxWidth: "1120px", margin: "0 auto", width: "100%", borderTop: "2px solid var(--text)" }}>
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(160px, 1fr))", gap: "1.5rem", marginBottom: "1.5rem" }}>
        <div>
          <strong style={{ color: "var(--text)", fontSize: "0.95rem", display: "block", marginBottom: "0.75rem", fontFamily: "var(--font-serif)", fontWeight: "900", textTransform: "uppercase" }}>Product</strong>
        ...
        <div>
          <strong style={{ color: "var(--text)", fontSize: "0.95rem", display: "block", marginBottom: "0.75rem", fontFamily: "var(--font-serif)", fontWeight: "900", textTransform: "uppercase" }}>Resources</strong>
          <nav style={{ display: "flex", flexDirection: "column", gap: "0.45rem" }}>
        ...
        <div>
          <strong style={{ color: "var(--text)", fontSize: "0.95rem", display: "block", marginBottom: "0.75rem", fontFamily: "var(--font-serif)", fontWeight: "900", textTransform: "uppercase" }}>Company</strong>
          <nav style={{ display: "flex", flexDirection: "column", gap: "0.45rem" }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", gap: "1rem", flexWrap: "wrap", borderTop: "1px solid var(--text)", paddingTop: "0.85rem", fontSize: "0.75rem", color: "var(--text-secondary)", fontFamily: "var(--font-mono)" }}>
